...
(function (global) {
    ...
    var S = {
        ...
        verified_creator: L('认证创作者', '認證創作者', 'Verified creator', 'Verifizierter Creator'),
        home_follow_plus: L('+ 关注', '+ 關注', '+ Follow', '+ Folgen'),
        home_following_done: L('已关注', '已關注', 'Following', 'Gefolgt'),
        home_following_check: L('已关注 ✓', '已關注 ✓', 'Following ✓', 'Gefolgt ✓'),
        home_online: L('在线', '在線', 'Online', 'Online'),
        home_creator: L('创作者', '創作者', 'Creator', 'Creator'),
        home_hours_ago: L('小时前', '小時前', 'hours ago', 'Std. zuvor'),
        home_zoom_hint: L('点击放大 · 右键可保存', '點擊放大 · 右鍵可儲存', 'Click to enlarge · right-click to save', 'Klicken zum Vergrößern · Rechtsklick speichern'),
        home_danmaku: L('实时弹幕', '即時彈幕', 'Live comments', 'Live-Kommentare'),
        home_send_gift: L('送礼', '送禮', 'Send gift', 'Geschenk senden'),
        home_bookmark: L('收藏', '收藏', 'Save', 'Speichern'),
        home_report: L('举报', '檢舉', 'Report', 'Melden'),
        home_points_reward: L('积分奖励', '積分獎勵', 'Points reward', 'Punktebelohnung'),
        home_points_hint: L('避开创作按钮 · 可收起侧边', '避開創作按鈕 · 可收起側邊', 'Avoid create FAB · collapse to side', 'FAB meiden · seitlich einklappen'),
        home_points_fold: L('收起到侧边', '收起到側邊', 'Collapse to side', 'Seitlich einklappen'),
        home_about: L('关于', '關於', 'About', 'Über'),
        home_service: L('服务', '服務', 'Terms', 'Nutzung'),
        home_privacy: L('隐私', '隱私', 'Privacy', 'Datenschutz'),

        gift_send_intent: L('送出心意', '送出心意', 'Send a gift', 'Geschenk senden'),
        gift_hero_desc: L('礼物会以飘屏 / 全屏特效送达，并出现在创作者打赏榜前列', '禮物會以飄屏 / 全屏特效送達，並出現在創作者打賞榜前列', 'Gifts play floating / full-screen effects and appear on the tip leaderboard', 'Geschenke erscheinen als Effekt und in der Trinkgeld-Rangliste'),
        gift_just_sent_diamond: L('🎁 你刚刚送出 钻石礼物！', '🎁 你剛剛送出 鑽石禮物！', '🎁 You just sent a Diamond gift!', '🎁 Du hast gerade ein Diamant-Geschenk gesendet!'),
        gift_ctx_content: L('内容打赏', '內容打賞', 'Content tip', 'Content-Trinkgeld'),
        gift_ctx_live: L('直播打赏', '直播打賞', 'Live tip', 'Live-Trinkgeld'),
        gift_tab_hot: L('热门', '熱門', 'Hot', 'Beliebt'),
        gift_tab_heart: L('心意', '心意', 'Heart', 'Herz'),
        gift_tab_boost: L('助力', '助力', 'Boost', 'Boost'),
        gift_tab_luxury: L('豪华', '豪華', 'Luxury', 'Luxus'),
        gift_tab_limited: L('限定', '限定', 'Limited', 'Limitiert'),
        gift_rose: L('玫瑰', '玫瑰', 'Rose', 'Rose'),
        gift_beer: L('啤酒', '啤酒', 'Beer', 'Bier'),
        gift_cake: L('蛋糕', '蛋糕', 'Cake', 'Kuchen'),
        gift_heart_box: L('心意盒', '心意盒', 'Heart Box', 'Herzbox'),
        gift_rocket: L('火箭', '火箭', 'Rocket', 'Rakete'),
        gift_diamond: L('钻石', '鑽石', 'Diamond', 'Diamant'),
        gift_unicorn: L('独角兽', '獨角獸', 'Unicorn', 'Einhorn'),
        gift_castle: L('城堡', '城堡', 'Castle', 'Schloss'),
        gift_ufo: L('飞碟', '飛碟', 'UFO', 'UFO'),
        gift_crown: L('皇冠', '皇冠', 'Crown', 'Krone'),
        gift_selected: L('已选礼物', '已選禮物', 'Selected', 'Ausgewählt'),
        gift_msg_ph: L('说点什么吧（最多 30 字，会显示在飘屏上）', '說點什麼吧（最多 30 字，會顯示在飄屏上）', 'Say something (max 30 chars, shown on the flyover)', 'Schreib etwas (max. 30 Zeichen)'),
        gift_bonus_empty: L('暂无打赏加成卡 · 去积分商城兑换，让创作者收到更多心意', '暫無打賞加成卡 · 去積分商城兌換，讓創作者收到更多心意', 'No tip boost cards yet · redeem in Points Mall so creators receive more', 'Noch keine Boost-Karten · im Punkte-Shop einlösen'),
        gift_wallet_balance: L('钱包余额：', '錢包餘額：', 'Wallet balance: ', 'Wallet-Guthaben: '),
        gift_recharge_hint: L('余额不足？立即充值', '餘額不足？立即儲值', 'Low balance? Top up now', 'Niedriges Guthaben? Jetzt aufladen'),
        gift_send_now: L('立即送出', '立即送出', 'Send now', 'Jetzt senden'),
        gift_per_unit: L('个', '個', 'each', 'Stk.'),
        cat_photo: L('摄影', '攝影', 'Photography', 'Fotografie'),
        cat_travel: L('旅行', '旅行', 'Travel', 'Reisen'),
        cat_video: L('视频', '影片', 'Video', 'Video'),
        cat_kyoto: L('京都', '京都', 'Kyoto', 'Kyoto'),
        cat_music: L('音乐', '音樂', 'Music', 'Musik'),
        cat_live_show: L('现场', '現場', 'Live show', 'Live'),
        cat_tech: L('科技', '科技', 'Tech', 'Tech'),
        cat_web3: L('Web3', 'Web3', 'Web3', 'Web3'),
        cat_film: L('胶片', '膠片', 'Film', 'Film'),
        cat_portrait: L('人像', '人像', 'Portrait', 'Porträt'),
        cat_life: L('生活', '生活', 'Lifestyle', 'Lifestyle'),
        cat_vlog: L('Vlog', 'Vlog', 'Vlog', 'Vlog'),
        cat_art: L('绘画', '繪畫', 'Art', 'Kunst'),
        cat_streaming: L('直播', '直播', 'Live', 'Live'),
    ...
    // 补充常见变体（页面上略有差异的原文）
    [
        ['搜索创作者、内容或话题…', 'search_ph'],
        ['搜索…', 'search_ph_short'],
        ['暂无打赏加成卡 · <a href="points-mall.html">去积分商城兑换</a>，让创作者收到更多心意', 'gift_bonus_empty'],
        ['暂无打赏加成卡，去积分商城兑换，让创作者收到更多心意', 'gift_bonus_empty'],
        ['去积分商城兑换', 'nav_points_mall']
    ].forEach(function (pair) {
        if (!ZH_TO_KEY[pair[0]]) ZH_TO_KEY[pair[0]] = pair[1];
    });
    ...
    var AUTO_SELECTORS = [
        ...
        '.reward-dock .rd-hint',
        '.reward-dock .rd-fold',
        '.gift-modal .gift-hero h2',
        '.gift-modal .gift-hero > p',
        '.gift-modal .preview-fly > span:last-child',
        '.gift-modal .ctx',
        '.gift-modal .gift-tabs .tt',
        '.gift-modal .gift-item .nm',
        '.gift-modal .gift-item .hot',
        '.gift-modal .sel-info .lb',
        '.gift-modal .total-pill',
        '.gift-modal .tip-bonus-empty > span:last-child',
        '.gift-modal .gift-foot .bal a',
        '.gift-modal .gift-foot .btn',
        '.gift-modal .send-btn',
        '.h-cta',
        'table th'
    ].join(',');
